...
import { Users, Settings, FileText, ShieldCheck, ArrowLeft, FileSpreadsheet, DollarSign, MessageCircle, BarChart3, Calendar } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Link to={createPageUrl("CRM")} className="block">
            <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg hover:border-indigo-300 transition-all cursor-pointer h-full">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">CRM - Gestão de Leads</h3>
              <p className="text-sm text-gray-500">Gerencie leads e conversões de vendas</p>
            </div>
          </Link>
          )}
