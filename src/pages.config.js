...
import DetalheClienteCRM from './pages/DetalheClienteCRM';
import NovoClienteCRM from './pages/NovoClienteCRM';
...
export const PAGES = {
    ...
    "CRM": CRM,
    "DetalheClienteCRM": DetalheClienteCRM,
    "NovoClienteCRM": NovoClienteCRM,
}
